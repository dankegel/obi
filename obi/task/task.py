...
def build_task():
    ...
    with env.cd(env.project_dir):
        ...
        if env.config.has_key("build-cmd"):
            ...
            # If running meson succeeds, we make a file in the build directory
            # to signal to future obi processes that they don't need to re-run
            # meson (unless meson-args, and therefore sentinel_hash, changes).
            ...
            #   * else, run meson with meson-args and write SENTINEL_HASH to SENTINEL_PATH
